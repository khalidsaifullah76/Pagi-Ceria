    ...
    <section class="hero-area">
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-hero-post bg-overlay">
                <!-- Post Image -->
                <div class="slide-img bg-img" style="background-image: url(img/core-img/carousel1.jpeg);"></div>
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <!-- Post Content -->
                            <div class="hero-slides-content text-center">
                                <h2>Selamat Datang di Pagi Ceria</h2>
                                <p>Jelajahi koleksi tanaman hias, layanan sewa tanaman, jasa perawatan dan pembuatan taman profesional untuk mempercantik lingkungan Anda.</p>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            ...
                            <div class="hero-slides-content text-center">
                                ...
                                <p>Ikuti kami di media sosial dan dapatkan tips perawatan tanaman, inspirasi dekorasi, dan banyak lagi!</p>
                                <div class="welcome-btn-group">
                                    <a href="#" class="btn alazea-btn mr-30">GET STARTED</a>
                                    <a href="#" class="btn alazea-btn active">CONTACT US</a>
                                </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-heading text-center">
                        <h2>Layanan</h2>
                        <p>Kami jamin Anda mendapat layanan terbaik.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="alazea-service-area mb-100">
                        ...
                        <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="100ms">
                            ...
                            <div class="service-content">
                                <h5>Penyewaan Tanaman</h5>
                                <p>Dari yang klasik hingga yang unik, temukan tanaman yang sesuai dengan gaya dan kebutuhan Anda."</p>
                            </div>
                        </div>
                        ...
                        <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <!-- Content -->
                            <div class="service-content">
                                <h5>Pembuatan Taman</h5>
                                <p>Wujudkan taman impian Anda bersama kami. Kami siap membantu Anda mendesain dan membangun taman yang indah dan fungsional.</p>
                            </div>
                        </div>
                        ...
                        <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="500ms">
                            ...
                            <div class="service-content">
                                <h5>Dekorasi</h5>
                                <p>Jadikan acara Anda lebih berkesan dengan dekorasi tanaman dari Pagi Ceria. Kami siap menghias dengan sentuhan alami yang indah dan sempurna.</p>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-heading text-center">
                        <h2>Produk Kami</h2>
                        <p>Kami punya produk terbaik, yang pastinya menarik perhatian anda</p>
                    </div>
                </div>
            </div>
